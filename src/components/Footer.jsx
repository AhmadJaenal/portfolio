...
const columns = [
  ...
  },
  {
    title: "Services",
    links: [
      { label: "App Development", to: "/about" },
      { label: "State Management", to: "/about" },
      { label: "API Integration", to: "/about" },
      { label: "DevOps & CI/CD", to: "/about" },
    ],
  },
  {
    title: "Projects",
    links: [
      { label: "ARP (Cerol)", to: "/portfolio/arp-cerol" },
...
const socials = [
  ...
  { Icon: BiLogoGithub, href: "#", label: "GitHub" },
];
    ...
    <footer className="mt-12 border-t border-slate-200 bg-slate-50 px-6 pb-8 pt-12 md:px-12 dark:border-[#1f1f1f] dark:bg-[#0a0a0a]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 text-sm text-slate-500 lg:flex-row dark:text-slate-500">
          <p>© {new Date().getFullYear()} DX. All rights reserved.</p>
